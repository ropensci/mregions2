...
The  package uses these two new functionalities to serve geometries in R as `sf::sf` objects, and allows to retrieve the Gazetteer database as `rdflib::rdf` objects. See `vignette("mregions2-rdf")` for further information.
