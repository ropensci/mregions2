...
The Marine Regions Gazetteer is hierarchically: This means that all the records got relations with each other. You can either pass the result of [gaz_search()] to [gaz_relations()] or an MRGID:
...
I recommend [the CQL/ECQL filtering vignette](https://emodnet.github.io/EMODnetWFS/articles/ecql_filtering.html) in the [EMODnetWFS] R package to know more. The principles explained there are useful also for mregions2.
