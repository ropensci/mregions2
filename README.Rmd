...
The entries of the Marine Regions Gazetteer are organized hierarchiely. You can browse this hierarchy up and down with [gaz_relations()]
...
You can visualize the Marine Regions Data Products with [mrp_view()]. It opens an interactive leaflet viewer.
...
Get to know more in the Introduction to mregions2 vignette `vignette("mregions2")`
