structure(list(method = "GET", url = "https://www.marineregions.org/rest/getGazetteerSources.json/?offset=500", 
    status_code = 404L, headers = structure(list(date = "Fri, 20 Jan 2023 13:33:22 GMT", 
