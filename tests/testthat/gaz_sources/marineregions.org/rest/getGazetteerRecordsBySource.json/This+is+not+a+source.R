structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerRecordsBySource.json/This+is+not+a+source/", 
    status_code = 404L, headers = structure(list(date = "Fri, 20 Jan 2023 13:33:21 GMT", 
