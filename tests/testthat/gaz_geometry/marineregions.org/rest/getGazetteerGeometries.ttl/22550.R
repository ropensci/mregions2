structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerGeometries.ttl/22550/", 
    status_code = 404L, headers = structure(list(date = "Fri, 20 Jan 2023 11:31:01 GMT", 
