structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerGeometries.ttl/49243/",
    status_code = 200L, headers = structure(list(date = "Thu, 19 Jan 2023 14:56:11 GMT",
