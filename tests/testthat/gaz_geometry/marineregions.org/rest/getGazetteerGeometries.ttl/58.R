structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerGeometries.ttl/58/",
    status_code = 200L, headers = structure(list(date = "Thu, 19 Jan 2023 14:57:15 GMT",
