structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerGeometries.ttl/999999999/", 
    status_code = 404L, headers = structure(list(date = "Thu, 19 Jan 2023 14:57:15 GMT", 
        ...
        `content-length` = "0", `content-type` = "text/turtle; charset=UTF-8;", 
