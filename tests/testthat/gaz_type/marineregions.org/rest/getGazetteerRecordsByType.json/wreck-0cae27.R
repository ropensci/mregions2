structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerRecordsByType.json/wreck/?offset=100", 
    status_code = 404L, headers = structure(list(date = "Fri, 20 Jan 2023 13:33:25 GMT", 
