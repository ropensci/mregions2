structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerRecordsByName.json/Belgie/?like=true&fuzzy=false&language=nl&typeID=&offset=0&count=100", 
