structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerRecordsByName.json/Belgie/?like=true&fuzzy=true&language=nl&typeID=&offset=100&count=100", 
    status_code = 404L, headers = structure(list(date = "Fri, 27 Jan 2023 15:16:43 GMT", 
        ...
        `set-cookie` = "REDACTED", connection = "keep-alive"), class = "httr2_headers"), 
