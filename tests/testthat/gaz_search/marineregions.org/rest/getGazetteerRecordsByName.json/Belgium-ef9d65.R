structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerRecordsByName.json/Belgium/?like=true&fuzzy=true&typeID=999999999&offset=0&count=100", 
    status_code = 404L, headers = structure(list(date = "Fri, 27 Jan 2023 15:16:47 GMT", 
