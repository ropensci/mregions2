structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerRecordsByName.json/Belgiun/?like=true&fuzzy=true&typeID=&offset=100&count=100", 
    status_code = 404L, headers = structure(list(date = "Fri, 27 Jan 2023 15:16:38 GMT", 
