structure(list(method = "GET", url = "api/rest/byname//Belgie/?like=true&fuzzy=true&language=es&typeID=&offset=0&count=100", 
    status_code = 404L, headers = structure(list(date = "Thu, 02 Feb 2023 14:26:01 GMT", 
