structure(list(method = "GET", url = "api/rest/byname//Belgium/?like=true&fuzzy=true&typeID=&offset=100&count=100", 
    status_code = 404L, headers = structure(list(date = "Thu, 02 Feb 2023 14:25:51 GMT", 
