structure(list(method = "GET", url = "api/rest/byname//Belgium/?like=true&fuzzy=true&typeID=193&offset=0&count=100", 
    status_code = 404L, headers = structure(list(date = "Thu, 13 Apr 2023 12:09:30 GMT", 
        ...
        `set-cookie` = "vliz_webc=vliz_webc2; path=/", connection = "keep-alive"), class = "httr2_headers"), 
