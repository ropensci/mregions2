structure(list(method = "GET", url = "api/rest/byname//test_like_is_false/?like=false&fuzzy=true&typeID=&offset=0&count=100", 
    status_code = 404L, headers = structure(list(date = "Thu, 13 Apr 2023 12:13:24 GMT", 
        ...
        `set-cookie` = "vliz_webc=vliz_webc1; path=/", connection = "keep-alive"), class = "httr2_headers"), 
