structure(list(method = "GET", url = "api/rest/relations//49243/?direction=lower&type=influencedby", 
    status_code = 404L, headers = structure(list(date = "Wed, 19 Apr 2023 12:36:50 GMT", 
