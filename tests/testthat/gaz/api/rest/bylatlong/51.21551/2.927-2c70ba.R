structure(list(method = "GET", url = "api/rest/bylatlong//51.21551/2.927/?typeID=999999999&offset=0", 
    status_code = 404L, headers = structure(list(date = "Thu, 13 Apr 2023 12:27:29 GMT", 
