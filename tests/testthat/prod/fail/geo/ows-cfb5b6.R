structure(list(method = "GET", url = "geo/ows?service=wfs&version=2.0.0&request=GetFeature&typeName=MarineRegions%3Aeez&cql_filter=notvalidparameter%3D3293&outputFormat=SHAPE-ZIP", 
