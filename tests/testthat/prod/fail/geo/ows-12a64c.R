structure(list(method = "GET", url = "geo/ows?service=wfs&version=2.0.0&request=GetFeature&typeName=MarineRegions%3Aeez&cql_filter=mrgid%3D%27cannotcast%27&outputFormat=text%2Fcsv", 
    status_code = 400L, headers = structure(list(`Access-Control-Allow-Origin` = "*", 
        ...
        Date = "Wed, 05 Apr 2023 11:44:01 GMT"), class = "httr2_headers"), 
