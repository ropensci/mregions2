structure(list(method = "GET", url = "https://marineregions.org/rest/getGazetteerRecordsByName.json/Bouvet/?like=false&fuzzy=true&typeID=&offset=100&count=100", 
    status_code = 404L, headers = structure(list(date = "Fri, 20 Jan 2023 13:33:17 GMT", 
